...
def compilar_regex_campos() -> dict[str, re.Pattern]:
    regex_campos = {}

    for campo_atual, rotulos_atuais in PADROES_EQUIVALENTES.items():
        outros_rotulos = []
        ...
        regex_campos[campo_atual] = re.compile(pattern)

    return regex_campos


REGEX_CAMPOS = compilar_regex_campos()
